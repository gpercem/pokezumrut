...
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} zateb\nfelçli!");
...
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX}'ın kafası karışık!");
...
static const u8 sText_MagnitudeStrength[] = _("{B_BUFF1} ŞİDDETLİ DEPREM!");
...
static const u8 sText_StatSharply[] = _("çokça ");
const u8 gText_StatRose[] = _("yükseldi!");
static const u8 sText_StatHarshly[] = _("çokça ");
static const u8 sText_StatFell[] = _("düştü!");
static const u8 sText_AttackersStatRose[] = _("{B_ATK_NAME_WITH_PREFIX}'ın {B_BUFF1}'ı\n{B_BUFF2}");
const u8 gText_DefendersStatRose[] = _("{B_DEF_NAME_WITH_PREFIX}'ın {B_BUFF1}'ı\n{B_BUFF2}");
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("{B_LAST_ITEM} kullanınca, {B_SCR_ACTIVE_NAME_WITH_PREFIX}'ın\n{B_BUFF1}'ı {B_BUFF2}");
static const u8 sText_AttackersStatFell[] = _("{B_ATK_NAME_WITH_PREFIX}'ın {B_BUFF1}'ı\n{B_BUFF2}");
static const u8 sText_DefendersStatFell[] = _("{B_DEF_NAME_WITH_PREFIX}'ın {B_BUFF1}'ı\n{B_BUFF2}");
...
static const u8 sText_GoPkmn[] = _("Git! {B_PLAYER_MON1_NAME}!");
static const u8 sText_GoTwoPkmn[] = _("Gidin! {B_PLAYER_MON1_NAME} ve\n{B_PLAYER_MON2_NAME}!");
static const u8 sText_GoPkmn2[] = _("Git! {B_BUFF1}!");
static const u8 sText_DoItPkmn[] = _("Hadi! {B_BUFF1}!");
