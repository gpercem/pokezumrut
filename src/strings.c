...
const u8 gText_Able[] = _("GEÇERLİ");
const u8 gText_First_PM[] = _("BİRİNCİ");
const u8 gText_Second_PM[] = _("İKİNCİ");
const u8 gText_Third_PM[] = _("ÜÇÜNCÜ");
const u8 gText_Able2[] = _("GEÇERLİ");
const u8 gText_NotAble[] = _("GEÇERSİZ");
const u8 gText_Able3[] = _("GEÇERLİ!");
const u8 gText_NotAble2[] = _("GEÇERSİZ!");
