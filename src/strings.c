...
const u8 gText_TreeckoDollAndPrice[] = _("TREECKO DOLL 1,000 JETON");
const u8 gText_TorchicDollAndPrice[] = _("TORCHIC DOLL 1,000 JETON");
const u8 gText_MudkipDollAndPrice[] = _("MUDKIP DOLL   1,000 JETON");
...
const u8 gText_TrainerCardTime[] = _("ZAMAN");
...
const u8 gText_ContinueMenuTime[] = _("ZAMAN");
...
const u8 gText_SafariBallStock[] = _("SAFARI TOPU\nStok: {STR_VAR_1}");
...
const u8 gText_MaxHP[] = _("MAX. CAN");
...
const u8 gText_SavingTime[] = _("ZAMAN");
...
const u8 gText_CommunicationStandby5[] = _("İletişim bekleniyor…");
