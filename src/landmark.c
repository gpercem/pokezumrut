...
static const u8 LandmarkName_FlowerShop[] = _("ÇİÇEK DÜKKANI");
static const u8 LandmarkName_PetalburgWoods[] = _("PETALBURG ORMANI");
static const u8 LandmarkName_MrBrineysCottage[] = _("BAY BRINEY'İN EVİ");
static const u8 LandmarkName_AbandonedShip[] = _("TERK EDİLMİŞ GEMİ");
static const u8 LandmarkName_SeashoreHouse[] = _("LEBİDERYA EVİ");
static const u8 LandmarkName_SlateportBeach[] = _("SLATEPORT SAHİLİ");
static const u8 LandmarkName_CyclingRoad[] = _("BİSİKLET YOLU");
static const u8 LandmarkName_NewMauville[] = _("YENİ MAUVİLLE");
static const u8 LandmarkName_TrickHouse[] = _("NUMARA EVİ");
static const u8 LandmarkName_OldLadysRestShop[] = _("DİNLENME EVİ");
static const u8 LandmarkName_Desert[] = _("ÇÖL");
static const u8 LandmarkName_WinstrateFamily[] = _("WİNSTRATE AİLESİ");
static const u8 LandmarkName_CableCar[] = _("TELEFERİK");
static const u8 LandmarkName_GlassWorkshop[] = _("CAM ATÖLYESİ");
static const u8 LandmarkName_WeatherInstitute[] = _("HAVA ENSTİTÜSÜ");
static const u8 LandmarkName_MeteorFalls[] = _("METEOR ŞELALESİ");
static const u8 LandmarkName_TunnelersRestHouse[] = _("TÜNELCİ DİNLENME EVİ");
static const u8 LandmarkName_RusturfTunnel[] = _("RUSTURF TÜNELİ");
static const u8 LandmarkName_PokemonDayCare[] = _("POKéMON BAKIMEVİ");
static const u8 LandmarkName_SafariZoneEntrance[] = _("SAFARI BÖLGESİ GİRİŞİ");
static const u8 LandmarkName_MtPyre[] = _("PYRE DAĞI");
static const u8 LandmarkName_ShoalCave[] = _("SHOAL MAĞARASI");
static const u8 LandmarkName_SeafloorCavern[] = _("DENİZ ALTI MAĞARASI");
static const u8 LandmarkName_GraniteCave[] = _("GRANİT MAĞARASI");
static const u8 LandmarkName_OceanCurrent[] = _("OKYANUS AKINTISI");
static const u8 LandmarkName_LanettesHouse[] = _("LANETTE'İN EVİ");
static const u8 LandmarkName_FieryPath[] = _("ATEŞLİ YOL");
static const u8 LandmarkName_JaggedPass[] = _("ENGEBELİ YOL");
static const u8 LandmarkName_SkyPillar[] = _("GÖK SÜTUNU");
static const u8 LandmarkName_BerryMastersHouse[] = _("MEYVE USTASI EVİ");
static const u8 LandmarkName_IslandCave[] = _("ADA MAĞARASI");
static const u8 LandmarkName_DesertRuins[] = _("ÇÖL HARABELERİ");
static const u8 LandmarkName_ScorchedSlab[] = _("KURAK MAĞARA");
static const u8 LandmarkName_AncientTomb[] = _("ANTİK MEZAR");
static const u8 LandmarkName_SealedChamber[] = _("MÜHÜRLÜ MAĞARA");
static const u8 LandmarkName_FossilManiacsHouse[] = _("FOSİL DELİSİ EVİ");
static const u8 LandmarkName_HuntersHouse[] = _("AVCININ EVİ");
static const u8 LandmarkName_MagmaHideout[] = _("MAGMA SIĞINAĞI");
static const u8 LandmarkName_MirageTower[] = _("SERAP KULESİ");
static const u8 LandmarkName_AlteringCave[] = _("DEĞİŞİM MAĞARASI");
static const u8 LandmarkName_DesertUnderpass[] = _("ÇÖL ALT GEÇİDİ");
static const u8 LandmarkName_TrainerHill[] = _("EĞİTMEN TEPESİ");
