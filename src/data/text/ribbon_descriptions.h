const u8 gRibbonDescriptionPart1_Champion[] = _("ŞAMPİYONU yendi. ONUR");
const u8 gRibbonDescriptionPart2_Champion[] = _("ODASI Üyesi KURDELESİ");
const u8 gRibbonDescriptionPart1_CoolContest[] = _("HAVALI YARIŞMASI");
const u8 gRibbonDescriptionPart1_BeautyContest[] = _("GÜZELLİK YARIŞMASI");
const u8 gRibbonDescriptionPart1_CuteContest[] = _("ŞİRİNLİK YARIŞMASI");
const u8 gRibbonDescriptionPart1_SmartContest[] = _("ZEKA YARIŞMASI");
const u8 gRibbonDescriptionPart1_ToughContest[] = _("SERTLİK YARIŞMASI");
const u8 gRibbonDescriptionPart2_NormalRank[] = _("Normal Rütbe kazananı!");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("Süper Rütbe kazananı!");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("Hiper Rütbe kazananı!");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("Usta Rütbe kazananı!");
const u8 gRibbonDescriptionPart1_Winning[] = _("SAVAŞ KULESİ'nde 50SV");
const u8 gRibbonDescriptionPart2_Winning[] = _("olduğu için verildi.");
const u8 gRibbonDescriptionPart1_Victory[] = _("SAVAŞ KULESİ'nde Açık");
const u8 gRibbonDescriptionPart2_Victory[] = _("Seviye tamamladı.");
const u8 gRibbonDescriptionPart1_Artist[] = _("Süper model seçilme");
const u8 gRibbonDescriptionPart2_Artist[] = _("sonucu verilen KURDELE.");
const u8 gRibbonDescriptionPart1_Effort[] = _("Çok çalışmasının karşı-");
const u8 gRibbonDescriptionPart2_Effort[] = _("lığı olarak verildi.");
