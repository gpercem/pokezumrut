...
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("ŞAMPİYON KURDELESİ");
...
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("Semifinalist Kurdelesi");
...
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("Zorlukları Aşan");
...
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("Efsane");
...
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("Çalışkan Kurdelesi");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("Arkadaşlık Kurdelesi");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("Enerji Kurdelesi");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("Sevilen POKéMON'a");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("verilen bir Kurdele.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("POKéMON'a sevgiyi");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("gösteren Kurdele.");
