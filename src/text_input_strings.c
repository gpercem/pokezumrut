...
const u8 gText_NamingScreenKeyboard_ghijkl[] = _("{CLEAR 11}g{CLEAR 6}ğ{CLEAR 6}h{CLEAR 26}ı{CLEAR 7}i{CLEAR 7}j{CLEAR 7}k{CLEAR 30} ");
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 11}l{CLEAR 8}m{CLEAR 6}n{CLEAR 26}o{CLEAR 6}ö{CLEAR 6}p{CLEAR 6}r{CLEAR 27} ");
